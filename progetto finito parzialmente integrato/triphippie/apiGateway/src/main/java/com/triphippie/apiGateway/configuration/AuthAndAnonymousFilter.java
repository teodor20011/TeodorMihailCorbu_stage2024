...
@Component
public class AuthAndAnonymousFilter extends AbstractGatewayFilterFactory<AuthAndAnonymousFilter.Config> {
    private final WebClient.Builder webClientBuilder;

    @Autowired
    public AuthAndAnonymousFilter(WebClient.Builder webClientBuilder) {
        super(AuthAndAnonymousFilter.Config.class);
